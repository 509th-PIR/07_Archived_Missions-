...
Last modified:  3/26/19 by SkyeGuy
...
private _orca = ["O_Heli_Light_02_F","	O_Heli_Light_02_unarmed_F","O_Heli_Light_02_dynamicLoadout_F"];
private _hellcat = ["I_Heli_light_03_F","I_Heli_light_03_dynamicLoadout_F"];
...
//===cars===
private _qilin = ["O_T_LSV_02_armed_F","O_T_LSV_02_AT_F","O_LSV_02_armed_F","O_LSV_02_AT_F"];
...
private _slingHeli = ["I_Heli_Transport_02_F","B_Heli_Transport_01_camo_F","B_Heli_Transport_01_F","B_Heli_Transport_03_unarmed_F","B_Heli_Transport_03_F"];				// sling capable
...
//=================================Misc======================================
//===== BLACK camo (colors everything black)
...
//===== NATO camo (colors everything OD)
...
/*
//===== Remove certain weapons from all vehicles (Laser Designator):
{
