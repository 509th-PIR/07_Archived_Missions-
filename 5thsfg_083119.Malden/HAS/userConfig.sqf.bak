...
RYD_HAS_signalTimeLimit = 120;//how long (seconds) helicopter should loiter waiting for the signal before task fail/RTB (set 0 for unlimited)
...
RYD_HAS_ChopperLvl = 10;//optimal chopper's flight ceiling
...
RYD_HAS_CAS_OnlyKnownTargets = true;//if true, CAS helicopter will shoot only at hostile targets actually known to its crew or the caller unit
