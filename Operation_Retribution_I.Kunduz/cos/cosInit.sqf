...
blackListTowns = ["protection_zone","base"];// Remove towns from COS

whiteListMkrs=["TAOR"];// Add Custom Markers for COS to populate 
...
COScivPool =["C_mas_med_Civil_1_1_F","C_mas_med_Civil_1_2_F","C_mas_med_Civil_1_3_F","C_mas_med_Civil_1_4_F","C_mas_med_Civil_2_1_F","C_mas_med_Civil_2_2_F","C_mas_med_Civil_2_3_F","C_mas_med_Civil_2_4_F"];	
COSmotPool =["C_Offroad_01_F","C_Van_01_transport_F","C_Van_01_box_F","RHS_Ural_Civ_01","RHS_Ural_Open_Civ_01","RHS_Ural_Civ_03","RHS_Ural_Open_Civ_03"];
